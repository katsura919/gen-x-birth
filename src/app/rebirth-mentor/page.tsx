        ...
        <div className="relative z-10 mx-auto grid min-h-[95vh] max-w-7xl grid-cols-1 items-center gap-12 px-6 pt-24 pb-16 lg:grid-cols-2 lg:gap-16 lg:px-12 lg:py-12">
          ...
          >
            ...
            <p className="font-inter max-w-xl text-xl leading-relaxed text-text-secondary">
              Reconnect with who you are, what you need, and the life you truly want.
            </p>
          ...
          <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
            ...
            <div
              className={`space-y-8 transition-all duration-1000 ${
                pain.isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
              }`}
            >
              ...
              <div className="space-y-5 font-inter text-lg leading-relaxed text-text-primary">
                ...
                <p>
                  You&apos;ve carried the emotional weight of your family, your relationships, your
                  career — often all at once, often in silence.
                </p>
                <p>
              ...
              <blockquote className="border-l-4 border-emotional-accent pl-6 font-cormorant text-2xl italic text-text-primary">
                &ldquo;You&apos;ve spent so long being strong for everyone else — it&apos;s okay to
                be held for a change.&rdquo;
              </blockquote>
            </div>
            ...
            <div
              className={`relative transition-all duration-1000 delay-300 ${
                pain.isVisible ? "translate-x-0 opacity-100" : "translate-x-12 opacity-0"
              }`}
            >
          ...
          <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
            ...
            >
              ...
              <div className="space-y-4 font-inter text-lg leading-relaxed text-text-secondary">
                ...
                <p>It&apos;s asking for something you&apos;ve put off for years:</p>
              </div>
          ...
          <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
            ...
            <div
              className={`space-y-10 transition-all duration-1000 ${
                quiz.isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
              }`}
            >
              <div className="space-y-4">
                ...
                <p className="font-inter text-lg text-text-secondary">
                  In just a few minutes, you&apos;ll identify where you are, understand what&apos;s
                  keeping you stuck, and know your next step.
                </p>
              </div>
            ...
            <div
              className={`relative transition-all duration-1000 delay-300 ${
                quiz.isVisible ? "translate-x-0 opacity-100" : "translate-x-12 opacity-0"
              }`}
            >
      ...
      <section className="bg-bg-main py-24 sm:py-32">
        <div ref={why.ref} className="mx-auto max-w-7xl px-6 lg:px-12">
          <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
            ...
            <div
              className={`space-y-8 transition-all duration-1000 delay-200 ${
                why.isVisible ? "translate-x-0 opacity-100" : "translate-x-8 opacity-0"
              }`}
            >
              <h2 className="font-playfair text-4xl font-bold leading-tight text-primary sm:text-5xl">
              ...
              <div className="space-y-5 font-inter text-lg leading-relaxed text-text-primary">
                ...
                <p>
                  It happened in the small moments — when you put your needs aside to keep the
                  peace, when you silenced your wants to meet someone else&apos;s, when you defined
                  your worth by how much you could carry.
                </p>
                <p>
                  Caregiving, self-sacrifice, people-pleasing — they&apos;re taught to us.
                  <br />
                  Praised in us.
                  <br />
                  Rewarded in us.
        ...
        <div ref={celeste.ref} className="mx-auto max-w-7xl px-6 lg:px-12">
          <div
            className={`mb-16 text-center transition-all duration-1000 ${
              celeste.isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
            }`}
          >
            <p className="font-dm-sans text-sm font-semibold uppercase tracking-[0.2em] text-secondary">
              Your Guide
          ...
          <div className="grid grid-cols-1 items-start gap-16 lg:grid-cols-2">
            ...
            >
              ...
              <p className="text-text-secondary">
                I know what it&apos;s like to be the strong one. To hold everything together while
                quietly falling apart inside.
              </p>
              <p className="text-text-secondary">
                I raised my daughters on my own, built my life from scratch more than once, and
                carried weight that was never meant for one person.
              </p>
              <p className="text-text-secondary">
                I did it with grace. And I did it at a cost.
              </p>
              <p className="text-text-secondary">
                It took reaching midlife to finally ask myself a real question:
              </p>
              <blockquote className="border-l-4 border-emotional-accent pl-6 font-cormorant text-2xl italic text-text-primary">
                &ldquo;What would it feel like to choose <em>myself</em>?&rdquo;
              </blockquote>
              <p className="text-text-secondary">That question changed everything.</p>
              <p className="text-text-secondary">
                Now I walk alongside women who are ready to stop surviving and start{" "}
        ...
        >
          <h2
            className={`font-playfair text-4xl font-bold text-white sm:text-5xl md:text-6xl transition-all duration-1000 ${
              believes.isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
            }`}
          >
            This Is Not a Breakdown.
            <span className="mt-2 block italic text-accent-dark">This Is a Rebirth.</span>
          </h2>
        ...
        <div ref={offer.ref} className="mx-auto max-w-7xl px-6 lg:px-12">
          ...
          <div
            className={`mb-16 space-y-4 text-center transition-all duration-1000 ${
              offer.isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
            }`}
          >
            <p className="font-dm-sans text-sm font-semibold uppercase tracking-[0.2em] text-secondary">
              Your Path Forward
            ...
            <p className="mx-auto max-w-2xl font-inter text-lg text-text-secondary">
              Whether you prefer deep 1:1 support or the power of sisterhood, there&apos;s a path
              designed for exactly where you are.
            </p>
          </div>
          ...
          <div className="mb-16 grid grid-cols-1 gap-8 md:grid-cols-2">
            ...
            <div
              className={`flex flex-col rounded-[2rem] bg-bg-light p-10 shadow-lg transition-all duration-700 hover:-translate-y-2 hover:shadow-xl ${
                offer.isVisible ? "translate-y-0 opacity-100" : "translate-y-12 opacity-0"
              }`}
            ...
            >
              ...
              <p className="mb-6 font-inter text-text-secondary">
                For the woman who&apos;s ready for a deeply personal, transformative journey. This
                is your space — held, private, and entirely focused on <em>you</em>.
              </p>
            ...
            >
              ...
              <p className="mb-6 font-inter text-white/80">
                You don&apos;t have to do this alone. Join a circle of women who understand exactly
                where you are — because they&apos;ve been there too.
              </p>
                ...
                {[
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="font-inter text-text-secondary">{outcome.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
      ...
      <section className="bg-bg-main py-24 sm:py-32">
        <div ref={note.ref} className="mx-auto max-w-7xl px-6 lg:px-12">
          <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
            ...
            <div
              className={`relative transition-all duration-1000 ${
                note.isVisible ? "translate-x-0 opacity-100" : "-translate-x-8 opacity-0"
              }`}
            >
              <div className="relative aspect-[3/4] overflow-hidden rounded-[2rem] shadow-xl">
                <Image
            ...
            >
              ...
              <div className="space-y-5 font-inter text-lg leading-relaxed text-text-secondary">
                <p>I see you.</p>
                <p>
                  I see the years of giving, the quiet ache of feeling unseen, the exhaustion
                  you&apos;ve learned to call normal.
                </p>
                ...
                <p>
                  Not just ready to feel better — ready to <em>be different</em>. Ready to stop
                  managing and start living.
                </p>
                <p>
                  You don&apos;t have to have it all figured out. You just have to be willing to
        ...
        <div ref={finalCta.ref} className="relative z-10 mx-auto max-w-3xl px-6 text-center">
          ...
          >
            ...
            <p className="mx-auto max-w-xl font-inter text-lg text-text-secondary">
              You&apos;ve read this far. Something in you recognized itself here.
              <br />
            ...
            <p className="font-inter text-lg text-text-secondary">
              ...
              <br />
              <span className="font-semibold text-primary">This is the moment.</span>
            </p>

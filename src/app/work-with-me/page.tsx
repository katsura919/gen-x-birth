  ...
  return (
    <ReactLenis root>
        ...
        <div className="relative z-10 mx-auto grid max-w-7xl grid-cols-1 items-center gap-8 px-6 pt-24 pb-16 sm:gap-12 lg:grid-cols-2 lg:gap-16 lg:px-12 lg:min-h-[90vh] lg:py-12">
          ...
          >
            ...
            <p className="font-inter max-w-xl text-xl leading-relaxed text-text-secondary">
              A private 1:1 session designed to give you clarity, direction, and a personalized
              path forward.
            </p>

            {/* Price pill */}
            <div className="inline-flex flex-wrap items-center gap-2 rounded-full bg-secondary/10 px-5 py-3 sm:gap-3 sm:px-6">
              <span className="font-dm-sans text-2xl font-bold text-secondary">$59</span>
          ...
          <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
            ...
            <div
              className={`space-y-8 transition-all duration-1000 ${
                qualify.isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
              }`}
            >
              ...
              <blockquote className="border-l-4 border-emotional-accent pl-6 font-cormorant text-2xl italic text-text-primary">
                &ldquo;If you nodded at even one of these — you&apos;re in the right place.&rdquo;
              </blockquote>
            </div>
        ...
        <div ref={session.ref} className="mx-auto max-w-4xl px-6 lg:px-12">
          <div
            className={`space-y-10 text-center transition-all duration-1000 ${
              session.isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
            }`}
          >
            <div className="space-y-4">
              <p className="font-dm-sans text-sm font-semibold uppercase tracking-[0.2em] text-secondary">
              ...
              <p className="mx-auto max-w-2xl font-inter text-xl text-text-secondary">
                In 60 minutes, we cut through the noise and get to the truth of where you are —
                and what&apos;s keeping you from where you want to be.
              </p>
            </div>
              ...
              {[
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="font-inter text-text-secondary">{item.text}</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            >
              <p className="font-cormorant text-2xl italic text-text-primary">
                &ldquo;One honest conversation can change the direction of everything.&rdquo;
              </p>
            </div>
            ...
            <a
              ...
              className={`block w-full rounded-full bg-secondary px-8 py-5 text-center font-dm-sans text-base font-semibold uppercase tracking-wider text-white shadow-lg transition-all duration-700 hover:bg-cta-hover hover:shadow-xl hover:-translate-y-1 sm:inline-block sm:w-auto sm:px-12 ${
                session.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
              }`}
            ...
            >
                ...
                {[
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="font-inter text-text-secondary">{item.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div
                className={`transition-all duration-700 delay-700 ${
                  getValue.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
                }`}
              >
                <a
                  href="https://genxrebirthmentor.setmore.com" target="_blank" rel="noopener noreferrer"
      ...
      <section className="bg-bg-main py-24 sm:py-28">
        <div ref={transition.ref} className="mx-auto max-w-4xl px-6 text-center lg:px-12">
          <div
            className={`space-y-8 transition-all duration-1000 ${
              transition.isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
            }`}
          >
            <p className="font-dm-sans text-sm font-semibold uppercase tracking-[0.2em] text-secondary">
              Ready to Go Deeper?
            ...
            <p className="mx-auto max-w-2xl font-inter text-xl text-text-secondary">
              The strategy session is just the beginning. For women who are ready to commit to
              real, lasting change — there are three paths forward.
            </p>

            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
              {[
                { phase: "Reset", months: "3 Months", sessions: "7 Sessions", desc: "Find your footing and release the overwhelm" },
                { phase: "Re-Align", months: "6 Months", sessions: "13 Sessions", desc: "Build consistency and create lasting change" },
                { phase: "Rebirth Year", months: "12 Months", sessions: "26 Sessions", desc: "Full identity transformation and life realignment" },
              ].map((item, i) => (
                <div
                  key={i}
                ...
                >
                  ...
                  <p className="font-inter text-sm text-text-secondary">{item.desc}</p>
                </div>
              ))}
            </div>
        ...
        <div ref={pricing.ref} className="mx-auto max-w-7xl px-6 lg:px-12">
          <div
            className={`mb-16 space-y-4 text-center transition-all duration-1000 ${
              pricing.isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
            }`}
          >
            <p className="font-dm-sans text-sm font-semibold uppercase tracking-[0.2em] text-secondary">
              Mentorship Packages
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            ...
            <div
              className={`flex flex-col rounded-[2rem] bg-white p-8 shadow-md ring-1 ring-primary/10 transition-all duration-700 hover:-translate-y-2 hover:shadow-xl ${
                pricing.isVisible ? "translate-y-0 opacity-100" : "translate-y-12 opacity-0"
              }`}
            ...
            >
              <div className="mb-6 space-y-1">
                ...
                <h3 className="font-playfair text-3xl font-bold text-primary">Reset Phase</h3>
              ...
              <div className="mb-8 flex items-baseline gap-2">
                <span className="font-playfair text-5xl font-bold text-text-primary">$347</span>
              ...
              <ul className="mb-8 space-y-3">
                {[
                  ...
                  <li key={i} className="flex items-start gap-3 font-inter text-text-primary">
                    {CHECK_ICON}
                    <span>{item}</span>
                  </li>
                ))}
            ...
            >
              ...
              <div className="mb-6 space-y-1 pt-4">
                ...
                <h3 className="font-playfair text-3xl font-bold text-white">Re-Align Phase</h3>
                <p className="font-inter text-white/70">
                  Build consistency, strengthen your foundation, and create change that lasts.
                </p>
              </div>

              <div className="mb-8 flex items-baseline gap-2">
                <span className="font-playfair text-5xl font-bold text-white">$497</span>
              ...
              <ul className="mb-8 space-y-3">
                {[
                  ...
                  <li key={i} className="flex items-start gap-3 font-inter text-white/90">
                    {CHECK_ICON_WHITE}
                    <span>{item}</span>
                  </li>
                ))}
            ...
            >
              <div className="mb-6 space-y-1">
                ...
                <h3 className="font-playfair text-3xl font-bold text-primary">Rebirth Year</h3>
                <p className="font-inter text-text-secondary">
                  For the woman who&apos;s ready for full transformation and long-term support.
                </p>
              </div>

              <div className="mb-8 flex items-baseline gap-2">
                <span className="font-playfair text-5xl font-bold text-text-primary">$697</span>
                <span className="font-inter text-text-secondary">USD</span>
              </div>
      ...
      ================================================ */}
      <section className="bg-bg-main py-24 sm:py-32">
        <div ref={trust.ref} className="mx-auto max-w-4xl px-6 text-center lg:px-12">
          <div
            className={`space-y-10 transition-all duration-1000 ${
              trust.isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
            }`}
          >
            <div className="space-y-4">
              <p className="font-dm-sans text-sm font-semibold uppercase tracking-[0.2em] text-secondary">
            ...
            <p
              className={`mx-auto max-w-2xl font-cormorant text-2xl italic text-text-primary transition-all duration-1000 delay-500 ${
                trust.isVisible ? "translate-y-0 opacity-100" : "translate-y-6 opacity-0"
              }`}
            >
              &ldquo;Women don&apos;t need fixing. They need a space to finally tell the truth —
              and someone who can hold it with them.&rdquo;
            </p>
          </div>
        </div>
      </section>
            ...
            >
              ...
              <div className="space-y-5 font-inter text-lg leading-relaxed">
                ...
                <p className="text-text-secondary">
                  I spent most of my life being the strong one — the woman who handled what needed
                  to be handled, kept things moving, and put everyone else&apos;s needs before her own.
                </p>
                <p className="text-text-secondary">
                  I know what it feels like to lose yourself in the giving. To wake up one day
                  and realize you&apos;ve been living for everyone except you.
                </p>
                <p className="text-text-secondary">
                  That realization wasn&apos;t a breakdown.
                  <br />
                  <span className="font-semibold text-primary">It was the beginning of my rebirth.</span>
                </p>
                <p className="text-text-secondary">
                  I do this work because I believe Gen X women are not past their prime — they
                  are in the most powerful season of their lives. They just need a space to see it.
                </p>
              </div>
      ...
      <section className="bg-bg-main py-24 sm:py-32">
        <div ref={objections.ref} className="mx-auto max-w-4xl px-6 lg:px-12">
          <div
            className={`space-y-10 transition-all duration-1000 ${
              objections.isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
            }`}
          >
      ...
      <section className="relative overflow-hidden bg-bg-light py-32 sm:py-40">
        ...
        <div ref={finalCta.ref} className="relative z-10 mx-auto max-w-3xl px-6 text-center">
          <div
            className={`space-y-8 transition-all duration-1000 ${
              finalCta.isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
            }`}
          >
            <p className="font-dm-sans text-sm font-semibold uppercase tracking-[0.2em] text-secondary">
              You&apos;re Ready
            ...
            <h2 className="font-playfair text-4xl font-bold text-primary sm:text-5xl md:text-7xl">
              ...
              <span className="mt-2 block italic text-accent-dark">Alone Anymore</span>
            </h2>
            ...
            <p className="mx-auto max-w-xl font-inter text-lg text-text-secondary">
              ...
              <br />
              <span className="font-semibold text-primary">Everything can shift from there.</span>
            </p>

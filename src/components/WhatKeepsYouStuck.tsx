            ...
            <div className="mx-auto max-w-4xl px-6 lg:px-8">
                ...
                <div className="space-y-8">
                    {points.map((point, index) => (
                        <div
                            key={index}
                            className={`flex gap-6 rounded-lg border-l-4 border-emotional-accent bg-bg-light/50 p-6 transition-all duration-700 hover:bg-bg-light ${isVisible ? 'translate-x-0 opacity-100' : 'translate-x-12 opacity-0'
                                }`}
                ...
                {/* Closing Quote */}
                <div className={`mt-20 border-l-8 border-secondary bg-highlight-bg p-8 sm:p-12 transition-all duration-1000 delay-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-12 opacity-0'}`}>
